...
output "vsi-subnets_count" {
  description = "The number of subnets created"
  value = module.vsi-subnets.count
}
output "vsi-subnets_ids" {
  description = "The ids of the created subnets"
  value = module.vsi-subnets.ids
}
output "vsi-subnets_names" {
  description = "The ids of the created subnets"
  value = module.vsi-subnets.names
}
output "vsi-subnets_subnets" {
  description = "The subnets that were created"
  value = module.vsi-subnets.subnets
}
output "vsi-subnets_acl_id" {
  description = "The id of the network acl for the subnets"
  value = module.vsi-subnets.acl_id
}
output "vsi-subnets_vpc_name" {
  description = "The name of the VPC where the subnets were provisioned"
  value = module.vsi-subnets.vpc_name
}
output "vsi-subnets_vpc_id" {
  description = "The id of the VPC where the subnets were provisioned"
  value = module.vsi-subnets.vpc_id
}
output "cluster_id" {
